...
<div id="page_content">
  ...
  <div id="duplicating_c">
    {include file='module_file_tpl:LISE;help_new_instances_tab.tpl'}
  </div>
  <div id="modes_c">
    {include file='module_file_tpl:LISE;help_modes_tab.tpl'}
  </div>
  <div id="field_c">
  ...
  <div id="developers_c">
    {include file='module_file_tpl:LISE;help_developers_tab.tpl'}
  </div>
  <div id="whatsnew_c">
    {include file='module_file_tpl:LISE;help_whats_new_tab.tpl'}
  </div>
	<div id="contribute_c">
