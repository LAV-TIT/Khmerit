<fieldset>
  ...
  <hr>
  <div class="pageoverflow">
    <p class="pagetext">{$fielddef->ModLang('fielddef_li_select_none')}:</p>
    <p class="pageinput">
      <input type="text" name="{$actionid}custom_input[select_none]" value="{$fielddef->GetOptionValue('select_none', '')}" />
    </p>
    <p class="pagetext"><div class="information">{$fielddef->ModLang('fielddef_li_select_none_help')}</div></p>
  </div>
</fieldset>