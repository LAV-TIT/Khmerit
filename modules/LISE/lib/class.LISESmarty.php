...
class LISESmarty 
{
  ...
  private static function _init()
  {
    if(!self::$_ready)
    {
      self::$_LI2_present = is_object( \cms_utils::get_module('ListIt2') );
  ...
  {
    $instance_name = api::getInstance()->InstanceName();
    if( empty($instance_name) ) $instance_name = '::NA::';
    return $instance_name;
  }
  
  public static function GenerateTitle($instance_name = '')
  {
    return api::getInstance()->GenerateTitle($instance_name);
  }
  
  public static function Log($message = '')
  {
    \lise_utils::log($message);
  }
