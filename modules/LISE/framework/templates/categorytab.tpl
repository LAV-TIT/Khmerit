  ...
  <table id="sortable_category" cellspacing="0" class="pagetable">
    <thead>
      <tr>
        ...
        <th data-ignore="highlight" data-hide="phone,tablet" data-class="hide-heading" data-sort-ignore="true" class="pageicon">&nbsp;</th>
        <th data-ignore="highlight" data-hide="phone,tablet" data-class="hide-heading" data-sort-ignore="true" class="pageicon">&nbsp;</th>
        <th data-ignore="highlight" data-hide="phone,tablet" data-class="hide-heading" data-sort-ignore="true" title="{$mod->ModLang('select_all')}" class="pageicon no-sort"><input id="check_all_category" type="checkbox" /></th>
      </tr>
    </thead>
