...
$lang['yellow'] = 'Yellow';
$lang['red'] = 'Red';
$lang['lise_mode_list_name'] = 'List Mode';
$lang['lise_mode_global_name'] = 'Global Mode';
$lang['lise_mode_local_name'] = 'Local Mode';
$lang['prompt_title_display_mode'] = 'Title Display Mode';
$lang['tdm_input'] = 'input';
$lang['tdm_readonly'] = 'readonly';
$lang['tdm_hidden'] = 'hidden';
$lang['prompt_title_auto_gen'] = 'Auto Generate Title';
$lang['prompt_title_template'] = 'Auto Generate Title Template';
$lang['prompt_alias_template'] = 'Auto Generate Alias Template';

// tabs
$lang['item'] = 'Item';
$lang['items'] = 'Items';
$lang['global'] = 'Global Settings';
$lang['local_settings'] = 'Settings';
...
$lang['option_click_arrows'] = 'Clicking arrows submits';
$lang['dlg_editor_np_warn_title'] = 'Confirmation';
$lang['dlg_editor_np_warning'] = '<p>You have made changes to this form and will lose them if you leave!</p><p>Are you sure you want to proceed?</p>';
...
$lang['fielddef_template'] = 'Template (deprecated)';
...
$lang['fielddef_resize_opt_legend'] = 'Resize Image Options';
$lang['fielddef_resize_opt_info'] = 'Allows the image to be resized on upload, will only work if <b>Expected to be image</b> is checked above.';
$lang['fielddef_resize_opt_enable_label'] = 'Enable Resize';
$lang['fielddef_resize_opt_max_img_w_label'] = 'Maximum Image Width';
$lang['fielddef_resize_opt_max_img_h_label'] = 'Maximum Image Height';
$lang['fielddef_resize_opt_keep_par_label'] = 'Keep Aspect Ratio';
$lang['fielddef_resize_opt_can_upscale_label'] = 'Allow Up-scaling';
$lang['fielddef_resize_opt_quality_label'] = 'Image Quality';
...
// CustomFromSmarty
$lang['fielddef_CustomFromSmarty'] = 'Custom Field From Smarty';
$lang['fielddef_source_template'] = 'Source Smarty Template';
$lang['fielddef_source_template_help'] = '
	<p>Fill <b>{$opts}</b> array with key value pairs and pass it to any of the following tags. <b>{$name}</b> and <b>{$sel}</b> are already provided by the module.</p>
	<p><b>{$name}</b> holds the field name (needed for RadioGroup, CheckboxGroup, or if you want to use pure html)</p>
	<p><b>{$sel}</b> holds the selected value if it exists.</p>
	<p>Example:<br>
	<b>{$opts = [1 => \'one\', 2 => \'two\']}<br>
  {html_options options=$opts selected=$sel}</b>
	</p>
	<p>For <b>Dropdown</b> and <b>MultiSelect</b> types use: <b>{html_options options=$opts selected=$sel}</b></p>
	<p>For <b>RadioGroup</b> type use: <b>{html_radios name=$name options=$opts selected=$sel separator=\'&lt;br />\'}</b></p>
	<p>For <b>CheckboxGroup</b> type use: <b>{html_checkboxes  name=$name options=$opts selected=$sel separator=\'&lt;br />\'}</b></p>
';

// LISEInstance
$lang['fielddef_LISEInstance'] = 'LISE Instance';
$lang['fielddef_li_select_none'] = 'Text for <i>none</i> option in list';
$lang['fielddef_li_select_none_help'] = 'Fill with a string: the module will try to find a language key in its resources for language strings. If it fails to load a valid string it will use the string to display the option. Leaving empty disables this.';
...
$lang['prompt_include_items'] = 'Items to Include in List';
$lang['ii_option_include_default'] = 'default';
$lang['ii_option_include_only_active'] = 'only active';
$lang['ii_option_include_only_inactive'] = 'only inactive';
$lang['ii_option_include_all'] = 'all';
...
// HelpPopup
$lang['fielddef_HelpPopup'] = 'Help Popup';
$lang['fielddef_ph_title'] = 'Dialog Title';
$lang['fielddef_ph_title_help'] = 'Set the title of the dialog (no HTML allowed). This field is required! if empty the dialog will be disabled.';
$lang['fielddef_ph_msg'] = 'Dialog Message';
$lang['fielddef_ph_msg_help'] = 'Set the message of the dialog. HTML can be used here but be cautious, it may break the dialog box.';

// Preview
$lang['fielddef_Preview'] = 'Preview';
$lang['fielddef_warning_preview'] = 'Warning: This preview panel behaves much like a browser window allowing you to navigate away from the initially previewed page. However, if you do that, you may experience unexpected behaviour. Navigating away from the initial page and returning will not give the expected results.';
$lang['fielddef_detail_template'] = 'Detail Template';
$lang['fielddef_detail_page'] = 'Detail Page';
...
$lang['module_main_options'] = 'Module Main Options';
$lang['module_advanced_options'] = 'Module Advanced Options';
...
$lang['prompt_hide_alias'] = 'Hide alias field from item editor (will be auto generated)';
$lang['prompt_hide_slug'] = 'Hide URL field from item editor (will be auto generated)';
$lang['prompt_hide_time_control'] = 'Do not use time control';
$lang['prompt_instance_mode'] = 'Instance operation mode';
$lang['prompt_local_instances_list'] = 'Instances in Local Mode';
$lang['prompt_separate_settings_control'] = 'Separate menu entry for instance settings';
...
$lang['instance_module_dna_saved'] = 'Module DNA created and saved';
...
$lang['missing_options_notice'] = 'Missing some options here? The missing options will only be possible with the <b>Allow system to install instances automatically</b> checkbox ticked on LISE options tab.';
$lang['instance_mode_notice'] = 'You will not be able to revert the following option once the module is installed. If you are not sure what to select, keep the default option <b>List Mode</b> selected as it is the usual, well known, LISE working mode. For further info please refer to the module help documentation.';
$lang['admin_section_info'] = 'You can select below a few options regarding LISE instances behaviour in the admin control interface. If you opt to have a separate menu entry for the instance settings these will always be under the <b>Site Admin</b> section and will have the following format: <b>Settings - 	&lt;Instance Friendly Name&gt;</b>.';
$lang['instance_mode_info'] = 'Operation modes will affect how <b>Module Admin Section</b> and <b>Separate menu entry for instance settings</b> work. Read help documentation for details.';
$lang['instance_mode'] = 'Mode';
$lang['mode_list'] = 'List';
$lang['mode_global'] = 'Global';
$lang['info_inactive_item_triggers_404'] = 'Previous behaviour allowed the item to be accessed by URL independently of its status. If this option is enabled, the item will be accessible only if it is active otherwise it will trigger a 404 exception therefore showing a 404 page. You can now use the custom 404 page type for this purpose.';
$lang['prompt_inactive_item_triggers_404'] = 'Inactive Items Trigger 404 Exception';
...
$lang['changes_saved_previous'] = 'Your previous item has been successfully saved.';
...
$lang['import_instance'] = 'Import from a LISE XML export generated file';
$lang['import_instance_info'] = 'You can leave the <strong>Instance Name</strong> field empty. The name of the instance will be extracted from XML by default.';
$lang['save_dna'] = 'Save DNA';
$lang['save_dna_title'] = 'Save DNA';
...
### help
$lang['title_template_popup_help_title'] = 'Title Template';
$lang['title_template_popup_help'] = '
<p>Smarty tags quick reference:
  <ul>
    <li><b>{ItemSingular}</b> - the instance preference stored to name the Item;</li>
    <li><b>{ItemPlural}</b> - the instance preference stored to name the Item;</li>
    <li><b>{ItemNextID}</b> - the expected item id of the new item when submitted;</li>
    <li><b>{ItemCounter}</b> - the expected # of the new item when submitted;</li>
    <li><b>{RandomString}</b> - a random string generator with the following parameters:
      <ul>
        <li><b>l=25</b> <i>(optional)</i> - the length of the string, default 10;</li>
        <li><b>f=ud</b> <i>(optional)</i> - mode flags:
          <ul>
            <li><b>m</b> (default) -  mixed: digits, upper and lower characters;</li>
            <li><b>d</b> - digits;</li>
            <li><b>u</b> - upper characters;</li>
            <li><b>l</b> - lower characters;</li>
          </ul>
        </li>
      </ul>
    </li>
...
<p>See module help for detailed explanation of the tags</p>
';
$lang['alias_template_popup_help_title'] = 'Alias Template';
$lang['alias_template_popup_help'] = '
<p>Smarty tags quick reference:
  <ul>
    <li><b>{ItemTitle}</b> - the manually inserted title or generated title from the previous template;</li>
    <li><b>{ItemSingular}</b> - the instance preference stored to name the Item;</li>
    <li><b>{ItemPlural}</b> - the instance preference stored to name the Item;</li>
    <li><b>{ItemNextID}</b> - the expected item id of the new item when submitted;</li>
    <li><b>{ItemCounter}</b> - the expected # of the new item when submitted;</li>
...
<p>See module help for detailed explanation of the tags</p>
';
$lang['slug_template_popup_help_title'] = 'URL Template';
$lang['slug_template_popup_help'] = '
<p>Smarty tags quick reference:
  <ul>
    <li><b>{Prefix}</b> - the URL prefix selected;</li>
    <li><b>{ItemTitle}</b> - the manually inserted title or generated title from the previous template;</li>
    <li><b>{ItemAlias}</b> - the manually inserted alias or generated alias from the previous template;</li>
    <li><b>{ItemCategory}</b> - the first determined category an item belongs to;</li>
    <li><b>{ItemPlural}</b> - the instance preference stored to name the Item;</li>
    <li><b>{ItemNextID}</b> - the expected item id of the new item when submitted;</li>
    <li><b>{ItemCounter}</b> - the expected # of the new item when submitted;</li>
    <li><b>{RandomString}</b> - a random string generator with the following parameters:
    ...
    <li><b>{$prefix}</b> - deprecated: use <b>{Prefix}</b>;</li>
    <li><b>{$item_title}</b> - deprecated: use <b>{ItemTitle}</b>;</li>
    <li><b>{$item_category}</b> - deprecated: use <b>{ItemCategory}</b>;</li>
  </ul>
</p>
<p>See module help for detailed explanation of the tags</p>
';
...
$lang['help_permissions'] = '<h3>Permissions</h3>
    ...
    <p>To allow non-admin users to upload files, please refer to the module(s) used to upload files settings.</p>';
...
$lang['00001'] = '%s: LISE error: %s!';
$lang['00002'] = '%s: LISE Database error: %s!';
$lang['00010'] = '%s: Attempt to write to configuration; LISE configuration variables are READ ONLY!';
$lang['00030'] = '%s: Failed to create dir %s!';
?>