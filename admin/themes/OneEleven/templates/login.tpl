			...
			<div class="login-container">
				<div class="login-box cf"{if isset($error)} id="error"{/if}>
					...
					<form method="post" action="login.php">
						...
						{/if}
							<input class="btn_login loginsubmit" name="loginsubmit" type="submit" value="{'submit'|lang}" />
							<input class="cancel_login loginsubmit" name="logincancel" type="submit" value="{'cancel'|lang}" />
						</fieldset>
					</form>
					{if isset($smarty.get.forgotpw) && !empty($smarty.get.forgotpw)}
